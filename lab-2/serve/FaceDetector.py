...
def alignment_procedure(img, left_eye, right_eye):
    ...
    a = distance.find_euclidean_distance(np.array(left_eye), np.array(point_3rd))
    b = distance.find_euclidean_distance(np.array(right_eye), np.array(point_3rd))
    c = distance.find_euclidean_distance(np.array(right_eye), np.array(left_eye))
